...
//				}
    ...
    private void initAttrs(Context context, @Nullable AttributeSet attrs) {
        ...
        mSelectedItemTextColor = a.getColor(R.styleable.WheelPicker_selectedTextColor, Color.parseColor("#333333"));
        ...
        mCurtainBorderColor = a.getColor(R.styleable.WheelPicker_wheelCurtainBorderColor, Color.BLUE);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mIsShowCurtainBorder) {
            ...
            canvas.drawLine(mSelectedItemRect.right / 4, mSelectedItemRect.top, mSelectedItemRect.right * 3 / 4, mSelectedItemRect.top, mPaint);
            canvas.drawLine(mSelectedItemRect.right / 4, mSelectedItemRect.bottom, mSelectedItemRect.right * 3 / 4, mSelectedItemRect.bottom, mPaint);
