...
import com.necer.basic.utils.CommonUtils;
...
public class DividerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private int leftOffset;//横向分割线的左边偏移量
    ...
    public DividerItemDecoration(Context context, int orientation) {
        ...
        leftOffset = CommonUtils.dp2px(context, 15);
    }
    ...
    public DividerItemDecoration(Context context, int orientation, int dividerHeight, int dividerColor) {
        this(context, orientation);
        leftOffset = CommonUtils.dp2px(context, 0);
